...
DRY = [
    ...
    Scenario(
        ...
        ip_range=("KK", "22", "A9s", "A8s", "QQ", "JJ", "KJs", "QJs", "JTs", "T9s"),
        bet_fractions=(0.5, 1.0),
...
PAIRED = [
    ...
    Scenario(
        ...
        ip_range=("KJs", "KTs", "QQ", "A9s", "JJ", "TT", "QJs", "JTs", "T8s"),
...
THREE_BET = [
    ...
    Scenario(
        ...
        ip_range=("66", "44", "JJ", "A5s", "KhJh", "99", "QJs", "JTs", "T9s"),
        pot=200.0,
        bet_fractions=(0.5, 1.0),
    ...
    Scenario(
        ...
        ip_range=("AJs", "ATs", "KK", "A5s", "QQ", "66", "KQs", "QJs", "JTs"),
        pot=200.0,
        bet_fractions=(0.5, 1.0),
        concept="Nut Advantage",
        read_more=_READ_MORE["Nut Advantage"],
    ...
    Scenario(
        ...
        ip_range=("J9s", "A9s", "JJ", "A5s", "KdQd", "66", "QTs", "T8s", "KQo"),
        pot=200.0,
        bet_fractions=(0.5, 1.0),
        concept="Range Advantage",
        read_more=_READ_MORE["Range Advantage"],
